...
func TestLinuxVM(t *testing.T) {
	...
	yamlConfig, _ := ioutil.ReadFile("az-lz-test_data/vm-linux.yaml")
	...
	testLinuxMultipleVMs(t, resGroup.Name, &subscriptionID, expectedVMConfig)

	testLinuxVMImageAndDisk(t, &expectedVMConfig.RsName, resGroup.Name, &subscriptionID, expectedVMConfig)

	testLinuxNetworkOfVM(t, resGroup.Name, &subscriptionID, expectedVMConfig)

	terraform.Destroy(t, options)
}

func testLinuxVMImageAndDisk(t *testing.T, vmName *string, resGroupName *string, subscriptionID *string, expectedVMConfig AzVM) {
...
func testLinuxMultipleVMs(t *testing.T, resGroupName *string, subscriptionID *string, expectedVMConfig AzVM) {
...
func testLinuxNetworkOfVM(t *testing.T, resGroupName *string, subscrID *string, expectedVMConfig AzVM) {
